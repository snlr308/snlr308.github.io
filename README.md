...
| **V-You/sunnyvale-onions-and-honey** | Where your agent gets root access to your produce! | `TypeScript` |
| **V-You/pliant-demo-architect-mcp** | Spin up tailored Pliant demo environments, test spend policies, and diagnose callback issues - all from the IDE. | `Nix/Lisp` |
...
*Last automated sync: 2026-03-08 (GitHub Actions)*
<!-- PROJECTS_END -->
